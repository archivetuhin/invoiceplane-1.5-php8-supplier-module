...
<div id="headerbar">
    ...
    <div class="headerbar-item pull-right">
        <div class="btn-group btn-group-sm">
            <a href="#" class="btn btn-default supplier-create-quote"
               data-supplier-id="<?php echo $supplier->supplier_id; ?>">
                <i class="fa fa-file"></i> <?php _trans('create_quote'); ?>
            </a>
            <a href="#" class="btn btn-default supplier-create-invoice"
               data-supplier-id="<?php echo $supplier->supplier_id; ?>">
...
<ul id="submenu" class="nav nav-tabs nav-tabs-noborder">
    ...
    <li><a data-toggle="tab" href="#supplierQuotes"><?php _trans('quotes'); ?></a></li>
    <li><a data-toggle="tab" href="#supplierInvoices"><?php _trans('invoices'); ?></a></li>
    <li><a data-toggle="tab" href="#supplierPayments"><?php _trans('payments'); ?></a></li>
</ul>
...
<div id="content" class="tabbable tabs-below no-padding">
    <div class="tab-content no-padding">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <table class="table table-bordered no-margin">
                        ...
                        <tr>
                            ...
                            <td class="td-amount">
                                <?php echo format_currency($supplier->supplier_invoice_total); ?>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <th class="td-amount">
                                <?php echo format_currency($supplier->supplier_invoice_paid); ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td class="td-amount">
                                <?php echo format_currency($supplier->supplier_invoice_balance); ?>
                            </td>
                        </tr>
                    </table>
                            ...
                            <table class="table no-margin">
                                ...
                                <?php foreach ($custom_fields as $custom_field) : ?>
                                    ...
                                    <tr>
                                        ...
                                        $value = $this->mdl_supplier_custom->form_value('cf_' . $custom_field->custom_field_id);
                                        ?>
        ...
        <div id="supplierQuotes" class="tab-pane table-content">
            <?php echo $quote_table; ?>
        </div>

        <div id="supplierInvoices" class="tab-pane table-content">
            <?php echo $invoice_table; ?>
        </div>

        <div id="supplierPayments" class="tab-pane table-content">
