            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-md"><?php _trans('suppliers'); ?></span>
                        <i class="visible-md-inline fa fa-users"></i>
                    </a>
                    <ul class="dropdown-menu">
                        <li><?php echo anchor('suppliers/form', trans('add_suppliers')); ?></li>
                        <li><?php echo anchor('suppliers/index', trans('view_suppliers')); ?></li>
                    </ul>
                </li>
                ...
                <li class="dropdown d-none hide hidden">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-caret-down"></i> &nbsp;
